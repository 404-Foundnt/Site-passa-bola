...
export default function CreateMatch(){
  ...
  function onSubmit(e){
    e.preventDefault();
    toast.success("Partida criada! Vamos registrar nos bastidores.");
  ...
  return (
    <div className="max-w-xl card">
      ...
      <form className="mt-4 grid gap-3" onSubmit={onSubmit}>
        ...
        <div><div className="label">Time visitante</div><Combobox label="Time visitante" options={TEAM_OPTIONS} value={form.away} onChange={(v)=>update("away", v)} placeholder="Selecione o adversário…" searchPlaceholder="Buscar time…" /></div>
        ...
        <div><div className="label">Local</div><Combobox label="Local" options={VENUE_OPTIONS} value={form.venue} onChange={(v)=>update("venue", v)} placeholder="Selecione o local…" searchPlaceholder="Buscar local…" /></div>
